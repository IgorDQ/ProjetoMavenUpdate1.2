...
class ClienteDAOTest {
    ...
    void deveSalvarClienteComSucesso() throws Exception {
        ...
        when(DatabaseConnection.getConnection()).thenReturn(conn);
        ...
        try (MockedStatic<DatabaseConnection> mocked = mockStatic(DatabaseConnection.class)) {
            ...
            idGerado = dao.salvar(clienteMock);
        }
    ...
    void deveLancarExcecaoAoFalharSalvarCliente() throws Exception {
        ...
        try (MockedStatic<DatabaseConnection> mocked = mockStatic(DatabaseConnection.class)) {
            ...
            SQLException ex = assertThrows(SQLException.class, () -> dao.salvar(clienteMock));
    ...
    void deveRetornarTrueQuandoAtualizarClienteComSucesso() throws Exception {
        ...
        try (MockedStatic<DatabaseConnection> mocked = mockStatic(DatabaseConnection.class)) {
            mocked.when(DatabaseConnection::getConnection).thenReturn(conn);
            boolean atualizado = dao.atualizar(new Cliente(1, "Pedro", 40, "Campinas", null));
